        ...
        <body>
            <header>
                ...
                <div class="icons">
                    ...
                    <a href="clientaime.php"><i class="fa fa-heart"><span>(<?=$nbrelikes;?>)</span></i></a>
            ...
            <div class="produit"> <p><span>Nos</span>Legumes</p></div>
            ...
            <nav class="bar">
                        <ul>
                                            ...
                                            <li><a href="#">Carotte</a> </li>
                                            <li><a href="#">Tomate</a> </li>
                                            <li><a href="#">Chou</a> </li>
                                            <li><a href="#">Aurier</a> </li>
                                            <li><a href="#">Epinard</a> </li>
                                            <li><a href="#">Piment rouge</a> </li>
            ...
            <section class="boxcontainert">
                            <?php
                                 include 'login.php';
    
                            $req="SELECT * FROM marchandise  WHERE codetypemarchandise= 0";
                        ...
                        <?php
                            ...
                            {
                                echo '<p class ="empty">Pas de Legume disponible</p>';
                            }
                        ?>
             </section>
