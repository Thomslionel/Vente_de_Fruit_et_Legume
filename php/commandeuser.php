...
if(isset($_SESSION['idpersonne']))
{
    if(isset($_GET['delete']))
    {
        ...
        $produits="SELECT *FROM chariot WHERE idchariot='$deleteid'";
        include "login.php";
        $results =mysqli_query($conn,$produits);
        $delesqlc="DELETE FROM chariot Where idchariot ='$deleteid'";
        $testc =mysqli_query($conn,$delesqlc);
        header("Location:commandeuser.php");
...
<html>
    ...
    <body>
        ...
        <div class="produit"> <p><span>Vos</span>Commandes</p></div>
        ...
        <section class="boxcontainerte">
                            ...
                            <div class="box">
                                            <div class="space">
                                                        ...
                                                        <a href="#= <?=$rows['images']; ?>"><img src="../image/<?=$rows['images']; ?>" class="imagesbox" alt=""></a>   
                                                            ...
                                                            <div class="btne">
                                                                      <a href="commandeuser.php?delete=<?=$row['idchariot']; ?>" class="delete" onclick="return confirm('Supprimer ce Favoris ?');">Supprimer</a>
                                                      </div>
                                                </form>
         ...
         <div class="produit"> <p><span>Achat</span>Total</p></div>
         ...
         <?php
                    ...
                    ?>
                                ...
                                <div class="commande">
                                            ...
                                            <a href="usercommande.php">Commander</a>
