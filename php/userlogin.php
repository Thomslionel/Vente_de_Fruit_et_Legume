    ...
    <body>
        <header>
            ...
            <div class="icons">
               ...
               <!-- <div class='user'>
                    <div class='btncon'><a href="php/userconnect.php">Se connecter</a></div>
                </div>-->
        </header>
        ...
        <div class="center">
                ...
                <form method="post" action="usertraitement.php">
                    <div class="txt_field">
                    <input type="text" required  name="pusernameuser">
                    <span></span>
                    <label>Username</label>
                    </div>
                    <div class="txt_field">
                    <input type="password" required  name="ppassworduser">
                    <span></span>
                    <label>Password</label>
                    </div>
                    <input type="submit" value="Login" name="login">
                    <div class="signup_link">
                    Pas de compte <a href="userinscription.php">S'inscrire</a>
                    </div>
                </form>
    </div>
